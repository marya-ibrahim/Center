          ...
          <Col md={6} lg={3}>
            <Card className="border-0 shadow-sm text-center h-100">
              <Card.Body className="p-4">
                ...
                <h5 className="fw-bold mb-2">Emma Sullivan</h5>
                <p className="text-muted mb-2">Chief Librarian</p>
                <p className="small text-muted">
                  20+ years of experience in library science and community building.
                </p>
              </Card.Body>
            </Card>
          </Col>
          <Col md={6} lg={3}>
            <Card className="border-0 shadow-sm text-center h-100">
              <Card.Body className="p-4">
                ...
                <h5 className="fw-bold mb-2">Michael Chen</h5>
                <p className="text-muted mb-2">Technology Director</p>
                <p className="small text-muted">
                  Passionate about integrating technology with traditional library services.
                </p>
              </Card.Body>
            </Card>
          </Col>
          <Col md={6} lg={3}>
            <Card className="border-0 shadow-sm text-center h-100">
              <Card.Body className="p-4">
                ...
                <h5 className="fw-bold mb-2">Aisha Patel</h5>
                <p className="text-muted mb-2">Collection Manager</p>
                <p className="small text-muted">
                  Expert in curating diverse and inclusive book collections.
                </p>
              </Card.Body>
            </Card>
          </Col>
          <Col md={6} lg={3}>
            <Card className="border-0 shadow-sm text-center h-100">
              <Card.Body className="p-4">
                ...
                <h5 className="fw-bold mb-2">James Martinez</h5>
                <p className="text-muted mb-2">Community Outreach</p>
                <p className="small text-muted">
            ...
            <Col lg={8} className="text-center">
              ...
              <div className="d-flex flex-column flex-md-row justify-content-center gap-4 mb-4">
                ...
                <div>
                  ...
                  <p className="mb-0">123 Knowledge Street, Book City</p>
                </div>
              </div>
            </Col>
          </Row>
